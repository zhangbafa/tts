...
<template>
  <div class="flex h-screen">
    <aside class="w-52 h-full bg-white p-4 border-r overflow-y-scroll relative hidden">
      <div
      ...
      <div class="absolute bottom-0 left-0 right-0">
        <div class="p-6 text-sm">
          ...
          >
            <UIcon name="i-heroicons-arrow-up-right-20-solid" class="text-xl" />
            了解更多
          </div>
        </div>
        <UDivider />
        <div
          class="flex justify-between items-center m-4 hover:bg-gray-300/100 p-1 px-2 rounded-full"
        >
          <UAvatar
    ...
    <main
      class="flex-1 overflow-auto relative justify-center items-center"
      id="scrollableDiv"
    >
      <!-- <header class="flex items-center justify-between bg-white p-4
        sticky top-0 mb-1.5  z-10 h-14 border-b bg-token-main-surface-primary
        ">
