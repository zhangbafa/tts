...
<template>
    <div class="flex h-screen">
        <aside class="w-52 h-full bg-white p-4 border-r overflow-y-scroll relative">
            <div
            ...
            <div class="absolute bottom-0 left-0 right-0">
                ...
                <UDivider/>
                <div class="flex justify-between items-center m-4 hover:bg-gray-300/100 p-1 px-2 rounded-full">
                    <UAvatar
    ...
    <main class="flex-1 overflow-auto relative  justify-center items-center" id="scrollableDiv">
