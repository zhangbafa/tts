const voices = [
  ...
  //const openai_tts = ["alloy", "echo", "fable", "onyx", "nova", "shimmer"];
  /*{
    Name: "OpenAI Text to Speech Voice",
    LocalName: "Alloy",
    ShortName: "Alloy",
    Gender: "Male",
    Provider: "openai",
...
const styles_obj = {
  ...
  affectionate: {
    style: "affectionate",
    description: "以较高的音调和音量表达温暖而亲切的语气",
  },
  ...
  excited: {
    style: "excited",
    description: "表达乐观和充满希望的语气",
  },
  fearful: {
    style: "fearful",
    description: "表达恐惧、紧张的语气",
  },
  friendly: {
    style: "friendly",
  ...
  serious: {
    style: "serious",
    description: "表达严肃和命令的语气",
  },
  shouting: {
    style: "shouting",
    description: "听起来好像声音在远处或在另一个地方的语气",
  },
  ...
  terrified: {
    style: "terrified",
    description: "表达一种害怕的语气，语速快且声音颤抖",
  },
 ...
 */
const openai_tts = ["alloy", "echo", "fable", "onyx", "nova", "shimmer"];
const openai_output_formats = ["mp3", "opus", "aac", "flac", "pcm"];
