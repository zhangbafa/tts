<template>
    <div class="mx-auto w-11/12 md:w-4/6 mb-20 border-b pb-10">
        <div class="text-3xl text-gray-080 text-center font-bold mt-20 mb-20">效果展示</div>
